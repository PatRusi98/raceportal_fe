...
import {deleteScoring} from "../../store/scoring/actions";

class DeleteScoringButton extends Component {
    ...
    delete=()=>{
        this.props.deleteScoring({id:this.props.id})
        this.toggle()
    }
    render() {
        return (
...
export default withRouter(
    connect(mapStateToProps, {deleteScoring})(withTranslation()(DeleteScoringButton))
);