...
class LicenseNew extends Component {

    handleValidSubmit = (event, values) => {
        let data = {...values}
        this.props.createLicense({data,history:this.props.history})
                                ...
                                <Card>
                                    <CardBody>
                                        <AvForm className="form-horizontal" onValidSubmit={this.handleValidSubmit}>
                                            <Row>
                                                <Col md={12}>
                                                    <h2>{this.props.t("New License")}</h2>
                                                </Col>
                                                <Col md={4}>
                                                    <AvField name="name"
...
export default withRouter(
    connect(mapStateToProps, {createLicense})(withTranslation()(LicenseNew))
);